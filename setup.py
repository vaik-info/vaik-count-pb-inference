...
if __name__ == '__main__':
    setuptools.setup(
        name="vaik-count-pb-inference",
        version="1.0.0",
        url="https://github.com/vaik-info/vaik-count-pb-inference.git",
        install_requires=load_requires_from_file('requirements.txt'),
        dependency_links=load_links_from_file('requirements.txt'),
        author="vaik-info",
        author_email="info@vaikobo.com",
        description="Inference with the count PB model.",
        long_description="Inference with the count PB model.",
